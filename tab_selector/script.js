...
btn.addEventListener('click',(a)=>{
    ...
    if(btn.className=='tab2'){
        ...
        left_box.style.backgroundSize=`500px 400px`;
        ...
        tab1.style.color='aquamarine';
        tab1.style.backgroundColor='black';
        left_box.style.background=`url('https://d2mk45aasx86xg.cloudfront.net/Web_development_frameworks_for_2022_scaled_e1640188210188_6585489c28.webp')`;
        left_box.style.backgroundSize=`500px 400px`;
    }else{
        btn.style.color='rgb(177, 14, 14)';
        btn.style.backgroundColor='bisque';
